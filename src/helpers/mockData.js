    ...
    links: [
      {
        rel: 'next',
        prompt: 'Next',
        href: 'https://images-api.nasa.gov/search?page=2&q=apollo'
      }
    ],
    version: '1.0',
    items: [
      ...
      {
        href:
          'https://images-assets.nasa.gov/video/NHQ_2018_0131_Super Blue Moon Lunar Eclipse/collection.json',
        links: [
          {
            href:
              'https://images-assets.nasa.gov/video/NHQ_2018_0131_Super Blue Moon Lunar Eclipse/NHQ_2018_0131_Super Blue Moon Lunar Eclipse~thumb.jpg',
            rel: 'preview',
            render: 'image'
          },
          {
            href:
              'https://images-assets.nasa.gov/video/NHQ_2018_0131_Super Blue Moon Lunar Eclipse/NHQ_2018_0131_Super Blue Moon Lunar Eclipse.srt',
            rel: 'captions'
          }
        ],
        data: [
